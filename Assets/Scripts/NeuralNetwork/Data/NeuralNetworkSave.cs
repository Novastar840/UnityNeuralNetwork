...
public class NeuralNetworkSave : ScriptableObject
{
	...
	/// <summary>
	/// Creates a deep copy of a serializable object using Unity's JsonUtility.
	/// </summary>
	public static T CloneViaJson<T>(T original)
	{
		// 1) Convert to JSON
		string json = JsonUtility.ToJson(original);
		// 2) Reconstruct a second object from that same JSON
